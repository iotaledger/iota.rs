...
description: Once a message is broadcast, you can use the Client.get_message_data() and Client.get_message_metadata() functions used to get all the information about the message from the Tangle.
...
`Client.get_message_data()` and `Client.get_message_metadata()` functions used to get all the information about the message from the Tangle.
