...
The function [`Client.postMessage(message)`](./../api_reference.md#clientpostmessagemessage--promiseany)
accepts a message instance as a parameter and sends it over a network. Alternatively, there is a convenient
[MessageBuilder](./../api_reference.md#messagebuilder) helper class with chaining calls that prepares a
