...
expects an address in Bech32 format and will get all outputs that use a given address.  You can use [OutputOptions](./../java/api_reference#outputsoptions) to limit the returned results.
