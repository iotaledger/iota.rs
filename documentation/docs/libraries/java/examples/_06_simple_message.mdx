...
You can use the [`Client.message()`](./../libraries/java/api_reference#message-clientmessagebuilder) to easily send any
message over the network. Alternatively, there is a convenient
[MessageSender](./../libraries/java/api_reference#messagebuilder) helper class with chaining calls that prepares a message
