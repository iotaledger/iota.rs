...
A [SignedTransaction](./../key_concepts/messages_payloads_and_transactions.md#signedtransaction) is a core payload type
that is used to send value-based messages as
[Unspent Transaction Output (UTXO)](./../key_concepts/messages_payloads_and_transactions#unspent-transaction-output-utxo).
