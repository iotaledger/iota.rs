...
A [message](../key_concepts/messages_payloads_and_transactions#messages) is an encapsulating data structure that is being actually broadcast across the network. It is an atomic unit that is either accepted or rejected as a whole.
