...
pub struct Transaction {
    ...
    attachment_timestamp: Option<String>,
    tag: Option<String>,
    attachment_timestamp_lower_bound: Option<String>,
    attachment_timestamp_upper_bound: Option<String>,
}
...
impl Transaction {
    pub fn attachment_timestamp_lower_bound(&self) -> Option<String> {
        self.attachment_timestamp_lower_bound.clone()
    }
    pub fn attachment_timestamp_lower_bound_mut(&mut self) -> &mut Option<String> {
        &mut self.attachment_timestamp_lower_bound
    }
    pub fn attachment_timestamp_upper_bound(&self) -> Option<String> {
        self.attachment_timestamp_upper_bound.clone()
    }
    pub fn attachment_timestamp_upper_bound_mut(&mut self) -> &mut Option<String> {
    ...
    pub fn current_index_mut(&mut self) -> &mut Option<i64> {
        &mut self.current_index
    }
    pub fn last_index(&self) -> Option<i64> {
        self.last_index
    }
    pub fn last_index_mut(&mut self) -> &mut Option<i64> {
        &mut self.last_index
    }
    ...
    pub fn attachment_timestamp(&self) -> Option<String> {
        self.attachment_timestamp.clone()
    }
    pub fn attachment_timestamp_mut(&mut self) -> &mut Option<String> {
