...
mod tests {
    ...
    const ADDR_SEED: &str = "LIESNFZLPFNWAPWXBLKEABZEEWUDCXKTRKZIRTPCKLKWOMJSEREWKMMMODUOFWM9ELEVXADTSQWMSNFVD";
    ...
    fn test_address_generation() {
        ...
        assert_eq!(api_utils::new_address(ADDR_SEED, 1, 0, false), "HIPPOUPZFMHJUQBLBVWORCNJWAOSFLHDWF9IOFEYVHPTTAAF9NIBMRKBICAPHYCDKMEEOXOYHJBMONJ9D");
        assert_eq!(api_utils::new_address(ADDR_SEED, 2, 0, false), "BPYZABTUMEIOARZTMCDNUDAPUOFCGKNGJWUGUXUKNNBVKQARCZIXFVBZAAMDAFRS9YOIXWOTEUNSXVOG9");
        assert_eq!(api_utils::new_address(ADDR_SEED, 3, 0, false), "BYWHJJYSHSEGVZKKYTJTYILLEYBSIDLSPXDLDZSWQ9XTTRLOSCBCQ9TKXJYQAVASYCMUCWXZHJYRGDOBW");

        let concat = ADDR_SEED.to_string() + ADDR_SEED;
        assert_eq!(api_utils::new_address(&concat, 1, 0, false), "VKPCVHWKSCYQNHULMPYDZTNKOQHZNPEGJVPEHPTDIUYUBFKFICDRLLSIULHCVHOHZRHJOHNASOFRWFWZC");
        assert_eq!(api_utils::new_address(&concat, 2, 0, false), "PTHVACKMXOKIERJOFSRPBWCNKVEXQ9CWUTIJGEUORSKWEDDJCBFQCCBQZLTYXQCXEDWLTMRQM9OQPUGNC");
        assert_eq!(api_utils::new_address(&concat, 3, 0, false), "AGSAAETPMSBCDOSNXFXIOBAE9MVEJCSWVP9PAULQ9VABOTWLDMXID9MXCCWQIWRTJBASWPIJDFUC9ISWD");
    }
}
