...
//         if bundle.bundle()[i].value().unwrap() < 0 {
//             let this_address = bundle.bundle()[i].address().clone().unwrap();
//             let mut key_index = 0;
...
//                 }
//             }
//             let bundle_hash = bundle.bundle()[i].bundle().clone().unwrap();
...
//                 if bundle.bundle()[i + j].address().clone().unwrap() == this_address
//                     && bundle.bundle()[i + j].value().unwrap() == 0
//                 {
