...
fn input_nft_eq_output_nft() {
    ...
    let outputs = build_outputs(vec![Nft(1_000_000, nft_id_2, BECH32_ADDRESS, None, None, None)]);
...
fn mint_nft() {
    ...
    let outputs = build_outputs(vec![Nft(1_000_000, nft_id_0, BECH32_ADDRESS, None, None, None)]);
...
fn nft_in_output_and_sender() {
    ...
    let outputs = build_outputs(vec![
        Nft(1_000_000, nft_id_1, BECH32_ADDRESS, None, None, None),
        Basic(1_000_000, BECH32_ADDRESS, None, Some(BECH32_ADDRESS_NFT)),
    ]);
...
fn increase_nft_amount() {
    ...
    let outputs = build_outputs(vec![Nft(3_000_000, nft_id_1, BECH32_ADDRESS, None, None, None)]);
...
fn decrease_nft_amount() {
    ...
    let outputs = build_outputs(vec![Nft(1_000_000, nft_id_1, BECH32_ADDRESS, None, None, None)]);
...
fn nft_burn_should_validate_nft_sender() {
    ...
    let outputs = build_outputs(vec![Basic(3_000_000, BECH32_ADDRESS, None, Some(BECH32_ADDRESS_NFT))]);
...
fn nft_burn_should_validate_nft_address() {
    ...
    let inputs = build_inputs(vec![
        Basic(2_000_000, BECH32_ADDRESS_NFT, None, None),
        Nft(1_000_000, nft_id_1, BECH32_ADDRESS, None, None, None),
    ]);
