...
use crate::input_selection::{
    build_basic_output, build_input_signing_data_basic_outputs, build_input_signing_data_nft_outputs, build_nft_output,
    unsorted_eq, BECH32_ADDRESS, BECH32_ADDRESS_ALIAS_SENDER, BECH32_ADDRESS_ED25519_SENDER, BECH32_ADDRESS_NFT_SENDER,
...
fn input_nft_eq_output_nft() {
    ...
    let inputs = build_input_signing_data_nft_outputs(vec![(1_000_000, nft_id_2, BECH32_ADDRESS, None)]);
...
fn basic_output_with_nft_input() {
    ...
    let inputs = build_input_signing_data_nft_outputs(vec![(2_229_500, nft_id_2, BECH32_ADDRESS, None)]);
    let outputs = vec![build_basic_output(2_000_000, BECH32_ADDRESS, None, None)];
...
fn burn_nft() {
    ...
    let inputs = build_input_signing_data_nft_outputs(vec![(2_000_000, nft_id_2, BECH32_ADDRESS, None)]);
    let outputs = vec![build_basic_output(2_000_000, BECH32_ADDRESS, None, None)];
...
fn not_enough_storage_deposit_for_remainder() {
    ...
    let inputs = build_input_signing_data_nft_outputs(vec![(1_000_001, nft_id_2, BECH32_ADDRESS, None)]);
    let outputs = vec![build_nft_output(1_000_000, nft_id_2, BECH32_ADDRESS, None, None, None)];
...
fn increase_nft_amount() {
    ...
    let mut inputs = build_input_signing_data_nft_outputs(vec![(2_000_000, nft_id_1, BECH32_ADDRESS, None)]);
    inputs.extend(build_input_signing_data_basic_outputs(vec![(
        1_000_000,
        BECH32_ADDRESS,
        None,
