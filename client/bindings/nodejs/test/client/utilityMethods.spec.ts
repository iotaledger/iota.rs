...
describe('Client utility methods', () => {
    ...
    it('hash output id', async () => {
        ...
        expect(aliasId).toBe("0xcf077d276686ba64c0404b9eb2d15556782113c5a1985f262b70f9964d3bbd7f");
    });
    ...
    it('alias id to address', async () => {
        ...
        const aliasAddress = await offlineClient.aliasIdToBech32(aliasId, "rms");

        expect(aliasAddress).toBe("rms1pr8swlf8v6rt5exqgp9eavk324t8sggnckseshex9dc0n9jd8w7h7wcnhn7");
    });
});
