...
public abstract class ApiTest {
    ...
    protected TransactionId setUpTransactionId(String address) throws ClientException, InitializeClientException, NoFundsFromFaucetReceivedException {
    ...
    protected OutputId setupOutputId(String address) throws ClientException, InitializeClientException, NoFundsFromFaucetReceivedException {
