...
impl SimpleTokenScheme {
    /// The [`TokenScheme`](crate::block::output::TokenScheme) kind of a [`SimpleTokenScheme`].
    pub const KIND: u8 = 0;
...
pub mod dto {
    ...
    use super::*;
    use crate::block::{dto::U256Dto, error::dto::DtoError};
