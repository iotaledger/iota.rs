...
const entryFilePath = path.join(__dirname, '../web/iota_client_wasm.js')
...
const entryFilePathTs = path.join(__dirname, '../web/iota_client_wasm.d.ts')
